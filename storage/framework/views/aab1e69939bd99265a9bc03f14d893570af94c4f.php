                        ...
                        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                            ...
                            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
										<?php echo Form::open(array('url' => url('/admin_login_check'), 'class'=>'form-horizontal', 'id'=>'frmLogin')); ?>
...
<script type="text/javascript" src="<?php echo e(URL::asset('public/js/admin/login.js')); ?>"></script>
<script>
