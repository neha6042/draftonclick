                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
										<?php echo Form::open(array('url' => url('/addBank'), 'class'=>'form-horizontal','enctype'=>'multipart/form-data', 'id'=>'frmAddBank')); ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
															...
															<?php echo Form::text('bank_name', null, array('class' => 'form-control','id'=>'bank_name','placeholder'=>'Enter Bank Name')); ?>									
                                                        </div>
                                                    </div>
													 <div class="col-md-6">
                                                        <div class="form-group">
                                                            <?php echo Form::label('file','Select Bank Logo'); ?>
