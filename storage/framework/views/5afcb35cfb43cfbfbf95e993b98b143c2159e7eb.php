                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
										<?php echo Form::open(array('url' => url('/addDepartment'), 'class'=>'form-horizontal','enctype'=>'multipart/form-data', 'id'=>'frmAddDepartment')); ?>
												...
												<div class="row">
                                                     <div class="col-md-6">
                                                        <div class="form-group">
															...
															<?php echo Form::text('dept_name', null, array('class' => 'form-control','id'=>'dept_name','placeholder'=>'Enter Department Name')); ?>									
                                                        </div>
                                                    </div>
													<div class="col-md-6">
                                                         <div class="form-group">
															...
															<?php echo Form::text('dept_manager_name', null, array('class' => 'form-control','id'=>'dept_manager_name','placeholder'=>'Enter Deptarment Manager Name')); ?>									
                                                        </div>
                                                    </div>											           
                                                </div>
												<div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
															...
															<?php echo Form::text('scale_of_dept_manager', null, array('class' => 'form-control','id'=>'scale_of_dept_manager','placeholder'=>'Enter Department Manager Scale')); ?>									
                                                        </div>
                                                    </div>	
													   <div class="col-md-6">
                                                         <div class="form-group">
															...
															<?php echo Form::text('dept_email', null, array('class' => 'form-control','id'=>'dept_email','placeholder'=>'Enter Department Email')); ?>									
                                                        </div>
                                                    </div>										           
													</div>
													<div class="row">
                                                   <div class="col-md-6">
                                                        <div class="form-group">
															...
															<?php echo Form::text('dept_alt_email', null, array('class' => 'form-control','id'=>'dept_alt_email','placeholder'=>'Enter Department Alternate Email')); ?>									
                                                        </div>
                                                    </div>
													  <div class="col-md-6">
                                                         <div class="form-group">
															...
															<?php echo Form::text('dept_manager_mobile_no', null, array('class' => 'form-control','id'=>'dept_manager_mobile_no','placeholder'=>'Enter Department Manager Mobile No.')); ?>									
                                                        </div>
                                                    </div>											           
													</div>
													<div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
															...
															<?php echo Form::text('dept_manager_contact_no', null, array('class' => 'form-control','id'=>'dept_manager_contact_no','placeholder'=>'Enter Department Manager Contact No.')); ?>									
                                                        </div>
                                                    </div>	
													<div class="col-md-6">
                                                         <div class="form-group">
															...
															<?php echo Form::text('dept_office_address', null, array('class' => 'form-control','id'=>'dept_office_address','placeholder'=>'Enter Department Office Address')); ?>									
                                                        </div>
                                                    </div>											           
													</div>
                                               </div>
