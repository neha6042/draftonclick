                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
										<?php echo Form::open(array('url' => url('/addBranch'), 'class'=>'form-horizontal','enctype'=>'multipart/form-data', 'id'=>'frmAddBranch')); ?>
												...
												<div class="row">
                                                     <div class="col-md-6">
                                                        <div class="form-group">
															...
															<?php echo Form::text('branch_name', null, array('class' => 'form-control','id'=>'branch_name','placeholder'=>'Enter Branch Name')); ?>									
                                                        </div>
                                                    </div>
													<div class="col-md-6">
                                                         <div class="form-group">
															<label for="branch_code">Enter Branch Code</label>
															<?php echo Form::text('branch_code', null, array('class' => 'form-control','id'=>'branch_code','placeholder'=>'Enter Branch Code')); ?>									
                                                        </div>
                                                    </div>											           
                                                </div>
												<div class="row">
                                                    <div class="col-md-6">
                                                         <div class="form-group">
															...
															<?php echo Form::text('branch_manager_name', null, array('class' => 'form-control','id'=>'branch_manager_name','placeholder'=>'Enter Branch Manager Name')); ?>									
                                                        </div>
                                                    </div>
													  <div class="col-md-6">
                                                        <div class="form-group">
															...
															<?php echo Form::text('scale_of_branch_manager', null, array('class' => 'form-control','id'=>'scale_of_branch_manager','placeholder'=>'Enter Branch Manager Scale')); ?>									
                                                        </div>
                                                    </div>											           
													</div>
													<div class="row">
                                                    <div class="col-md-6">
                                                         <div class="form-group">
															...
															<?php echo Form::text('branch_email', null, array('class' => 'form-control','id'=>'branch_email','placeholder'=>'Enter Branch Email')); ?>									
                                                        </div>
                                                    </div>
													  <div class="col-md-6">
                                                        <div class="form-group">
															...
															<?php echo Form::text('branch_alt_email', null, array('class' => 'form-control','id'=>'branch_alt_email','placeholder'=>'Enter Branch Alternate Email')); ?>									
                                                        </div>
                                                    </div>											           
													</div>
													<div class="row">
                                                    <div class="col-md-6">
                                                         <div class="form-group">
															...
															<?php echo Form::text('branch_manager_mobile_no', null, array('class' => 'form-control','id'=>'branch_manager_mobile_no','placeholder'=>'Enter Branch Manager Mobile No.')); ?>									
                                                        </div>
                                                    </div>
													  <div class="col-md-6">
                                                        <div class="form-group">
															...
															<?php echo Form::text('branch_manager_contact_no', null, array('class' => 'form-control','id'=>'branch_manager_contact_no','placeholder'=>'Enter Branch Manager Contact No.')); ?>									
                                                        </div>
                                                    </div>											           
													</div>
												<div class="row">
                                                    <div class="col-md-12">
                                                         <div class="form-group">
															...
															<?php echo Form::text('branch_office_address', null, array('class' => 'form-control','id'=>'branch_office_address','placeholder'=>'Enter Branch Office Address')); ?>									
                                                        </div>
                                                    </div>												           
                                                </div>
                                               </div>
