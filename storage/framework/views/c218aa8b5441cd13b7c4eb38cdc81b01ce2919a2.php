                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table class="table table-striped table-bordered table-responsive file-export">
                                            ...
                                            <tbody>
											<?php $j=1; ?>
											<?php $__currentLoopData = $arrCategoryDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<tr >
													<td><?php echo e($j++); ?></td>
													...
													<td><?php echo e($val->manager_name); ?></td>
													<td><?php echo e($val->manager_email); ?></td>
													<td><?php echo e($val->manager_alternate_email); ?></td>
													<td><?php echo e($val->manager_mobile_no); ?></td>
													<td><?php echo e($val->manager_contact_no); ?></td>
													<td><?php echo e($val->office_address); ?></td>
													<td>
														<a class="btn btn-icon btn-success mr-1" href="<?php echo e(url('/edit_category/'.base64_encode($val->id))); ?>" title="Edit Category"><i class="ft-edit"></i></a>

														<button type="button" class="btn btn-icon btn-success mr-1" data-toggle="modal" data-placement="top" data-target = "#myModal_del"  title="Delete Category" onclick ="  $('#delete_value').val(<?php echo e($val->id); ?>); "><i class="ft-delete"></i></button>
			  ...
			  <div class="modal fade" id="myModal_del" role="dialog">
				<div class="modal-dialog">
				  ...
				  <div class="modal-content">
						 <form name="forms_del" action="<?php echo e(url('delete_category')); ?>" method="POST"> 
