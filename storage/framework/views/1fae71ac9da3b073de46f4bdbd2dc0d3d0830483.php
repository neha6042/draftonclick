                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
										<?php echo Form::open(array('url' => url('/edit_category/'.base64_encode($arrCatEditData->id)), 'class'=>'form-horizontal', 'id'=>'frmAddCategory')); ?>
											...
											<input type="hidden" name="catId" id='' value="<?php echo e($arrCatEditData->id); ?>">
                                            <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="projectinput5">Select City of <span class="dynamicValue">Zonal</span> Office</label>
                                                             <select name="office_city" class="select2 form-control block" id="responsive_single" style="width: 100%">
																...
																<option value="<?php echo e($arrCatEditData->city); ?>" selected="selected" disabled=""><?php echo e($arrCatEditData->city); ?></option>
															  </select>
                                                        </div>
                                                   </div> 
                                                </div>
												<div class="row">
												   <div class="col-md-6">
                                                        <div class="form-group">
															...
															<?php echo Form::text('zonal_manager_name', $arrCatEditData->manager_name, array('class' => 'form-control','id'=>'zonal_manager_name','placeholder'=>'Enter Manager Name')); ?>									
                                                        </div>
                                                    </div> 
                                                    <div class="col-md-6">
                                                         <div class="form-group">
															<label for="zonal_manager_email">Enter <span class="dynamicValue">Zonal</span> Manager Email</label>
															<?php echo Form::text('zonal_manager_email', $arrCatEditData->manager_email, array('class' => 'form-control','id'=>'zonal_manager_email','placeholder'=>'Enter Manager Email')); ?>									
                                                        </div>
                                                    </div>												           
                                                </div>
													<div class="row">
													 <div class="col-md-6">
                                                        <div class="form-group">
															...
															<?php echo Form::text('zonal_manager_alt_email', $arrCatEditData->manager_alternate_email, array('class' => 'form-control','id'=>'zonal_manager_alt_email','placeholder'=>'Enter Manager Alternate Email')); ?>									
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                         <div class="form-group">
															<label for="zonal_manager_mobile_no">Enter <span class="dynamicValue">Zonal</span> Manager Mobile No.</label>
															<?php echo Form::text('zonal_manager_mobile_no', $arrCatEditData->manager_mobile_no, array('class' => 'form-control','id'=>'zonal_manager_mobile_no','placeholder'=>'Enter Manager Mobile No.')); ?>									
                                                        </div>
                                                    </div>									           
                                                </div>
												<div class="row">
												  <div class="col-md-6">
                                                        <div class="form-group">
															...
															<?php echo Form::text('zonal_manager_contact_no', $arrCatEditData->manager_contact_no, array('class' => 'form-control','id'=>'zonal_manager_contact_no','placeholder'=>'Enter Manager Contact No.')); ?>									
                                                        </div>
                                                    </div>	
                                                    <div class="col-md-6">
                                                         <div class="form-group">
															<label for="zonal_office_address">Enter <span class="dynamicValue">Zonal</span> Office Address</label>
															<?php echo Form::text('zonal_office_address', $arrCatEditData->office_address, array('class' => 'form-control','id'=>'zonal_office_address','placeholder'=>'Enter Office Address')); ?>									
                                                        </div>
                                                    </div>												           
                                                </div>
                                               </div>
