        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0">Manage Department</h3>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table class="table table-striped table-bordered table-responsive file-export">
                                            ...
                                            <tbody>
											<?php $j=1; ?>
											<?php $__currentLoopData = $arrDepartmentDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<tr >
													<td><?php echo e($j++); ?></td>
													...
													<td><?php echo e($val->dept_manager_name); ?></td>
													<td><?php echo e($val->scale_of_dept_manager); ?></td>
													<td><?php echo e($val->dept_email); ?></td>
													<td><?php echo e($val->dept_alt_email); ?></td>
													<td><?php echo e($val->dept_manager_mobile_no); ?></td>
													<td><?php echo e($val->dept_manager_contact_no); ?></td>
													<td><?php echo e($val->dept_office_address); ?></td>
													<td>
														<a class="btn btn-icon btn-success mr-1" href="<?php echo e(url('/edit_department/'.base64_encode($val->id))); ?>" title="Edit Department"><i class="ft-edit"></i></a>

														<button type="button" class="btn btn-icon btn-success mr-1" data-toggle="modal" data-placement="top" data-target = "#myModal_del"  title="Delete Department" onclick ="  $('#delete_value').val(<?php echo e($val->id); ?>); "><i class="ft-delete"></i></button>
			  ...
			  <div class="modal fade" id="myModal_del" role="dialog">
				<div class="modal-dialog">
				  ...
				  <div class="modal-content">
						 <form name="forms_del" action="<?php echo e(url('delete_department')); ?>" method="POST"> 
