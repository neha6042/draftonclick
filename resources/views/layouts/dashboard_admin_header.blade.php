        ...
        <div class="navbar-wrapper">
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item"><a class="navbar-brand" href="../../../html/ltr/vertical-menu-template/index.html"><img class="brand-logo" alt="stack admin logo" src="{{ URL::asset('public/app-assets/images/logo/draftonclickdashboard.jpg') }}">
            ...
            <div class="navbar-container content">
                <div class="collapse navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="avatar avatar-online"><img src={{ URL::asset('public/app-assets/images/admin/admin.png') }} alt="avatar"><i></i></span><span class="user-name">{{session()->get('username')}}</span></a>
