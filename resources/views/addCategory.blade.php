                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
										{!! Form::open(array('url' => url('/addCategory'), 'class'=>'form-horizontal', 'id'=>'frmAddCategory')) !!}
												...
												<div class="row">
												   <div class="col-md-6">
                                                        <div class="form-group">
															...
															{!! Form::text('zonal_manager_name', null, array('class' => 'form-control','id'=>'zonal_manager_name','placeholder'=>'Enter Manager Name')) !!}									
                                                        </div>
                                                    </div> 
                                                    <div class="col-md-6">
                                                         <div class="form-group">
															<label for="zonal_manager_email">Enter <span class="dynamicValue">Zonal</span> Manager Email</label>
															{!! Form::text('zonal_manager_email', null, array('class' => 'form-control','id'=>'zonal_manager_email','placeholder'=>'Enter Manager Email')) !!}									
                                                        </div>
                                                    </div>												           
                                                </div>
													<div class="row">
													 <div class="col-md-6">
                                                        <div class="form-group">
															...
															{!! Form::text('zonal_manager_alt_email', null, array('class' => 'form-control','id'=>'zonal_manager_alt_email','placeholder'=>'Enter Manager Alternate Email')) !!}									
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                         <div class="form-group">
															<label for="zonal_manager_mobile_no">Enter <span class="dynamicValue">Zonal</span> Manager Mobile No.</label>
															{!! Form::text('zonal_manager_mobile_no', null, array('class' => 'form-control','id'=>'zonal_manager_mobile_no','placeholder'=>'Enter Manager Mobile No.')) !!}									
                                                        </div>
                                                    </div>									           
                                                </div>
												<div class="row">
												  <div class="col-md-6">
                                                        <div class="form-group">
															...
															{!! Form::text('zonal_manager_contact_no', null, array('class' => 'form-control','id'=>'zonal_manager_contact_no','placeholder'=>'Enter Manager Contact No.')) !!}									
                                                        </div>
                                                    </div>	
                                                    <div class="col-md-6">
                                                         <div class="form-group">
															<label for="zonal_office_address">Enter <span class="dynamicValue">Zonal</span> Office Address</label>
															{!! Form::text('zonal_office_address', null, array('class' => 'form-control','id'=>'zonal_office_address','placeholder'=>'Enter Office Address')) !!}									
                                                        </div>
                                                    </div>												           
                                                </div>
                                               </div>
