                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table class="table table-striped table-bordered table-responsive file-export">
                                            ...
                                            <tbody>
											<?php $j=1; ?>
											@foreach($arrBranchDetails as $key => $val)
												<tr >
													<td>{{$j++}}</td>
													<td>{{$val->bank_name}}</td>
													...
													<td>{{$val->branch_manager_name}}</td>
													<td>{{$val->scale_of_branch_manager}}</td>
													<td>{{$val->branch_email}}</td>
													<td>{{$val->branch_alt_email}}</td>
													<td>{{$val->branch_manager_mobile_no}}</td>
													<td>{{$val->branch_manager_contact_no}}</td>
													<td>{{$val->branch_office_address}}</td>
													<td>
														<a class="btn btn-icon btn-success mr-1" href="{{url('/edit_branch/'.base64_encode($val->id))}}" title="Edit Category"><i class="ft-edit"></i></a>
			  ...
			  <div class="modal fade" id="myModal_del" role="dialog">
				<div class="modal-dialog">
				  ...
				  <div class="modal-content">
						 <form name="forms_del" action="{{url('delete_branch')}}" method="POST"> 
