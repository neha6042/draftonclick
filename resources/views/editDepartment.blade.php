                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
										{!! Form::open(array('url' => url('/edit_department/'.base64_encode($arrDeptEditData->id)), 'class'=>'form-horizontal','enctype'=>'multipart/form-data', 'id'=>'frmAddDepartment')) !!}
											<input type="hidden" name="token" value="{{ csrf_token() }}">
											<input type="hidden" name="url" id='url' value="{{ url('/get-cities') }}">
											<input type="hidden" name="deptId" id='' value="{{ $arrDeptEditData->id }}">
                                            <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="projectinput5">Select City of <span class="dynamicValue">Zonal</span> Office</label>
                                                             <select name="office_city" class="select2 form-control block" id="responsive_single" style="width: 100%">
																...
																<option value="{{$arrDeptEditData->city}}" selected="selected" disabled="">{{$arrDeptEditData->city}}</option>
															  </select>
                                                        </div>
                                                   </div> 
                                                </div>
												<div class="row">
                                                     <div class="col-md-6">
                                                        <div class="form-group">
															...
															{!! Form::text('dept_name', $arrDeptEditData->dept_name, array('class' => 'form-control','id'=>'dept_name','placeholder'=>'Enter Department Name')) !!}									
                                                        </div>
                                                    </div>
													<div class="col-md-6">
                                                         <div class="form-group">
															{!!Form::label('dept_manager_name','Enter Deptarment Manager Name')!!}
															{!! Form::text('dept_manager_name', $arrDeptEditData->dept_manager_name, array('class' => 'form-control','id'=>'dept_manager_name','placeholder'=>'Enter Deptarment Manager Name')) !!}									
                                                        </div>
                                                    </div>											           
                                                </div>
												<div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
															...
															{!! Form::text('scale_of_dept_manager', $arrDeptEditData->scale_of_dept_manager, array('class' => 'form-control','id'=>'scale_of_dept_manager','placeholder'=>'Enter Department Manager Scale')) !!}									
                                                        </div>
                                                    </div>	
													   <div class="col-md-6">
                                                         <div class="form-group">
															{!!Form::label('dept_email','Enter Department Email')!!}
															{!! Form::text('dept_email', $arrDeptEditData->dept_email, array('class' => 'form-control','id'=>'dept_email','placeholder'=>'Enter Department Email')) !!}									
                                                        </div>
                                                    </div>										           
													</div>
													<div class="row">
                                                   <div class="col-md-6">
                                                        <div class="form-group">
															...
															{!! Form::text('dept_alt_email', $arrDeptEditData->dept_alt_email, array('class' => 'form-control','id'=>'dept_alt_email','placeholder'=>'Enter Department Alternate Email')) !!}									
                                                        </div>
                                                    </div>
													  <div class="col-md-6">
                                                         <div class="form-group">
															{!!Form::label('dept_manager_mobile_no','Enter Department Manager Mobile No.')!!}
															{!! Form::text('dept_manager_mobile_no', $arrDeptEditData->dept_manager_mobile_no, array('class' => 'form-control','id'=>'dept_manager_mobile_no','placeholder'=>'Enter Department Manager Mobile No.')) !!}									
                                                        </div>
                                                    </div>											           
													</div>
													<div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
															...
															{!! Form::text('dept_manager_contact_no', $arrDeptEditData->dept_manager_contact_no, array('class' => 'form-control','id'=>'dept_manager_contact_no','placeholder'=>'Enter Department Manager Contact No.')) !!}									
                                                        </div>
                                                    </div>	
													<div class="col-md-6">
                                                         <div class="form-group">
															{!!Form::label('dept_office_address','Enter Department Office Address')!!}
															{!! Form::text('dept_office_address', $arrDeptEditData->dept_office_address, array('class' => 'form-control','id'=>'dept_office_address','placeholder'=>'Enter Department Office Address')) !!}									
                                                        </div>
                                                    </div>											           
													</div>
                                               </div>
